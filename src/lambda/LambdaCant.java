...
public class LambdaCant {
    public static void main(String[] args) {
        MathAddSub addSub = new MathAddSub() {
            @Override
        ...
        System.out.println("익명 클래스는 인터페이스 하나로 메서드 2개 가능 하지롱 ^0^, a + b = " + addSub.add(10, 20));
        System.out.println("익명 클래스는 인터페이스 하나로 메서드 2개 가능 하지롱 ^0^, a - b = " + addSub.sub(10, 20));
